            ...
            <form onSubmit={handleSignup} >
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-sm opacity-70'> Join Talk-Flow  and start your connections journey</p>
                </div>
                ...
                <div className='space-y-3'>
                  ...
                  {/* EMAIL  */}
                   ...
                   <div className='form-control w-full'>
                    ...
                    <input type="email" 
                    placeholder='soryasonu@1033.com'
                    className='input input-bordered w-full'
                   ...
                   <div className='form-control w-full'>
                    ...
                    required
                    />
                    <p className='text-xs opacity-70 mt-1'> Password must be atleast 6 character</p>
                  </div>
                  {/* tC */}
      ...
      <div className='max-w-md p-8'>
        {/* image  */}
          <div className='relative aspect-square max-w-sm mx-auto'>
            <img src="/signuppic.png" alt="language connection illustration" className='w-full h-full ' />
          </div>
          <div className='text-center space-y-3 mt-6'>
            <h2 className='text-xl font-semibold'> Connect With Friends Worldwide</h2>
            <p className='opacity-70'> Practise conversation make friends and improve your language skills together</p>
          </div>
      </div>
